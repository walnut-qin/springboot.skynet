...
public class ValueEnumTypeAdapter<E extends Enum> implements JsonSerializer<E>, JsonDeserializer<E> {
    ...
    ValueEnumToStringConverter<E> enumToStringConverter;

    // 逆向转换器工厂
    ValueStringToEnumConverterFactory stringToEnumConverterFactory;

    ValueEnumTypeAdapter(ValueEnumToStringConverter<E> enumToStringConverter,
            ValueStringToEnumConverterFactory stringToEnumConverterFactory) {
